  ...
  settings: {
    ...
    im: {
      ...
      connectedSteps: [
        ...
        "Keep Galley running to keep receiving WeChat messages.",
      ],
      ...
      runningHint: "Connected and receiving WeChat messages.",
