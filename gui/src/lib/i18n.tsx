...
const zhCopy = {
  ...
  app: {
    ...
    externalModelHint: "模型配置更新后重启 Yole 生效",
  ...
  sidebar: {
    ...
    newProject: "新建项目",
    projectMenu: "项目菜单",
    collapseProjectConversations: "折叠所有项目会话",
    expandProjectConversations: "展开所有项目会话",
    archiveAllChats: "归档所有聊天",
    organizeSidebar: "整理侧边栏",
    organizeByProject: "按项目",
    organizeRecentProjects: "近期项目",
    organizeByTime: "按时间顺序",
    organizeMoveDown: "下移",
    sortSidebar: "排序条件",
    sortByRecent: "最近活动优先",
    sortByName: "名称",
    ...
    pinProject: "置顶项目",
    unpinProject: "取消置顶项目",
    openProjectInExplorer: "在资源管理器中打开",
    renameProject: "重命名项目",
    removeProject: "移除",
    weeksAgo: (weeks: number) => `${weeks}周`,
  },
  topbar: {
    newConversation: "新对话",
    ...
    yoloOn: "自动执行已开启",
    yoloTooltip: "自动执行：跳过所有工具审批",
    yoloView: "自动执行已开启 · 点击查看",
  ...
  browserControl: {
    ...
    stepOpenTestPageHint: "Yole 会用测试页确认浏览器控制可用。",
  ...
  composer: {
    ...
    cannotSwitchRunning: "运行中暂时无法切换模型",
    switchCurrent: (name: string) => `当前模型：${name}`,
    configureModels: "配置模型",
    configureModelBeforeSending: "先配置模型",
    willCreateIn: (projectName: string) => `将创建到 ${projectName}`,
    savingImage: "正在保存图片",
    imagePasteFailed: "请重新粘贴图片",
    removePastedImage: "移除图片",
    previewPastedImage: "预览图片",
    pastedImageAlt: (index: number) => `已粘贴图片 ${index}`,
  },
  epigraph: {
    regionLabel: "题词",
  },
  ...
  settings: {
    ...
    approval: {
      ...
      yoloMode: "自动执行",
      yoloTooltip:
        "跳过审批让 Agent 自主运行，适合在隔离环境完全信任 Agent 时使用",
      yoloDescription:
        "跳过所有审批，Agent 自主执行。适合完全信任 Agent 的沙盒环境",
      toggleYolo: "切换自动执行",
      yoloEnabledTopbar: "自动执行已开启 · 顶部栏显示状态",
      turnOffNow: "立即关闭",
      yoloRulesPaused: "自动执行已开启，下列规则当前不生效（关闭后恢复）。",
      yoloRulesTitle: "自动执行已开启，下列规则当前不生效",
      ...
      turnOnYoloTitle: "打开自动执行？",
      yoloModalIntro: "开启后，所有工具调用将不经审批直接执行——包括：",
      goodFor: "适合",
      notFor: "不适合",
      goodForText: "完全信任 Agent + 在沙盒环境工作（个人 repo / 临时虚拟机）",
      notForText: "生产代码 / 共享系统 / 不熟悉的 Agent / 敏感数据",
      yoloIndicatorNote: "顶部栏会显示自动执行标识，随时可一键关闭。",
    ...
    agent: {
      ...
      sopDescription: "复制给你信任的本地 Agent，让它通过 Yole 调度 sessions。",
      sopCapabilities: [
        "继续现有 session",
        "新开单个 session",
  ...
  onboarding: {
    ...
    attachTrust: "Yole 不修改你的 GenericAgent。删除 Yole，它照常独立运行。",
  ...
  toasts: {
    ...
    modelConfigSavedMessage: "新对话立即生效；已启动的对话重启 Yole 后生效。",
  ...
  updates: {
    ...
    checkingShort: "检查中",
    waitForTasks: "等待任务",
    waitForTasksMessage: "当前还有任务在运行。请等任务结束后再更新。",
    preparingShort: "下载中",
    installNow: "立即更新",
    restart: "重启并更新",
    retry: "重试",
    ...
    foundAvailable: "发现新版本，点击“立即更新”后开始下载。",
    preparing: "正在下载更新",
    ready: "新版本已下载，重启 Yole 生效",
    readyAfterTasks: "当前任务结束后再重启",
    foundAfterTasks: "发现新版本，当前任务结束后可手动更新",
...
const enCopy: AppCopy = {
  ...
  app: {
    ...
    externalModelHint: "Restart Yole after updating model settings",
  ...
  sidebar: {
    ...
    collapseProjectConversations: "Collapse project chats",
    expandProjectConversations: "Expand project chats",
    archiveAllChats: "Archive all chats",
    organizeSidebar: "Organize sidebar",
    organizeByProject: "By project",
    organizeRecentProjects: "Recent projects",
    organizeByTime: "By time",
    organizeMoveDown: "Move down",
    sortSidebar: "Sort by",
    ...
    openProjectInExplorer: "Open in File Explorer",
  ...
  topbar: {
    ...
    yoloOn: "Auto-run is on",
    yoloTooltip: "Auto-run: skips all tool approvals",
    yoloView: "Auto-run is on · View details",
  ...
  settings: {
    ...
    approval: {
      ...
      yoloMode: "Auto-run",
      yoloTooltip:
        "Let Agent run without approval. Use only in trusted, isolated workspaces.",
      yoloDescription:
        "Skip approval for every action. Agent runs on its own; best for trusted sandbox work.",
      toggleYolo: "Toggle auto-run",
      yoloEnabledTopbar: "Auto-run is on · Shown in the top bar",
      turnOffNow: "Turn off now",
      yoloRulesPaused:
        "Auto-run is on. The rules below are paused until auto-run is turned off.",
      yoloRulesTitle: "Auto-run is on. The rules below are paused.",
      ...
      turnOnYoloTitle: "Turn on auto-run?",
      yoloModalIntro: "Tool calls will run without approval, including:",
      goodFor: "Good for",
      notFor: "Not for",
      goodForText:
      ...
      yoloIndicatorNote:
        "Yole will show an auto-run indicator in the top bar, and you can turn it off anytime.",
  ...
  toasts: {
    ...
    restartForExisting: "Restart Yole to apply this to existing conversations",
    ...
    updateAvailableMessage:
      "A new version is available. Update now, or run it later from system management.",
  ...
  yoloIntro: {
    title: "Auto-run is on by default",
  ...
  updates: {
    ...
    waitForTasksMessage:
      "A task is still running. Update after the task finishes.",
    ...
    foundAvailable:
      "A new version is available. Click Update now to download it.",
    ...
    foundAfterTasks:
      "New version found. Update manually after the current task finishes.",
