...
```
Cursor:   T3a.1  (M3a runtimeStore LLM concerns 抽离 — sub-plan 已 ship, 实施待开干)
Status:   🟢 M2 ✅ · perf baseline P1-P4 ✅ · 4 B2 latent bugs 修 (CLI 提问渲染 / LLM 持久化 / picker flash / picker spawning click) · M3 sub-plan ✅
Started:  2026-05-19
Last touch: 2026-05-19 — JC dev dogfood OK, 4 B2 fix shipped (4e7a6e6 / 9c36f42 / d6a096f / 317e816), perf baseline 落数 P1=3.15s short / 5.36s long / P2=1.42 ev/s / P3 CLI RTT mean 13-15ms / P4 cited prototype, M3 detailed sub-plan ship 在 B3-M3-sub-plan.md 决定 M3a/M3b 拆分。详 N5/N6/N7/N8
